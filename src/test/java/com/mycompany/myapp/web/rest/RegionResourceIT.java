...
class RegionResourceIT {
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region()
            ...
            .regionDesc(DEFAULT_REGION_DESC)
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region()
            ...
            .regionDesc(UPDATED_REGION_DESC)
    ...
    void createRegion() throws Exception {
        ...
        assertThat(testRegion.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testRegion.getLogo()).isEqualTo(DEFAULT_LOGO);
        assertThat(testRegion.getLogoContentType()).isEqualTo(DEFAULT_LOGO_CONTENT_TYPE);
    }
    ...
    void getAllRegions() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.[*].regionDesc").value(hasItem(DEFAULT_REGION_DESC.toString())))
    ...
    void getRegion() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.regionDesc").value(DEFAULT_REGION_DESC.toString()))
    ...
    void putNewRegion() throws Exception {
        ...
        assertThat(testRegion.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testRegion.getLogo()).isEqualTo(UPDATED_LOGO);
        assertThat(testRegion.getLogoContentType()).isEqualTo(UPDATED_LOGO_CONTENT_TYPE);
    }
    ...
    void partialUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.regionDesc(UPDATED_REGION_DESC).creationDate(UPDATED_CREATION_DATE);
